...
# Load the data
all_scores_df = pd.read_excel("2022_remix_sentiment_scores.xlsx")
...
plt.title("Sentiment Analysis Scores for 12 Student Files for remix Project", fontsize=20, fontweight='bold')
plt.xlabel("Student Number ", fontsize=16)
plt.ylabel("Sentiment Score", fontsize=16)
sns.despine(offset=10, trim=True)
plt.tight_layout()
plt.savefig("folder for plot/2022_ver2_remix_sentiment_analysis_scores.png")
plt.show()
